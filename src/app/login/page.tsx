...
export default function LoginPage() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.auth.resetPasswordForEmail(forgotEmail, {
      redirectTo: 'https://www.agrimarcheafrique.com/reset-password',
    })
    if (error) {
        ...
        {!showForgot ? (
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="text-right">
                <button
                  ...
                  className="text-sm text-[#0a4a2f] hover:underline"
                >
                  Mot de passe oublié ?
                </button>
              </div>
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1">On vous envoie un lien de réinitialisation</p>
            </div>
            ...
            {forgotSent ? (
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                {forgotError && (
                  <div className="bg-red-50 text-red-700 text-sm px-4 py-2 rounded-lg">{forgotError}</div>
                )}
